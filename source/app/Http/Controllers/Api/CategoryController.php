       ...
       if($nearbystore->del_range >= $nearbystore->distance)  {        
        $deal_p= DB::table('deal_product')
          ...
          if(count($top_selling)>0)
          {
            ...
            foreach ($top_selling as $prods) 
            {
                array_push($result1, $prods);
